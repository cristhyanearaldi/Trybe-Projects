...
Neste projeto, foi desenvolvida uma API de um CRUD (**C**reate, **R**ead, **U**pdate e **D**elete) de palestrantes. Desenvolveram-se alguns endpoints para ler e escrever em um arquivo, utilizando o módulo `fs`.
