...
// trazendo para o arquivo a const characters, pois está fora do escopo da função getCharacter. Dessa forma posso acessar os objetos
const characters = {
  arya: {
    name: 'Arya Stark',
    class: 'Rogue',
...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    assert.strictEqual(getCharacter('cris'), undefined);
  });
});
