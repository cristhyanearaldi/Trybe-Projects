...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // const objRetornado2 = createMenu({ food: {}, drink: {} });    --> linha inserida por mim
    // assert.deepStrictEqual(objetoRetornado.fetchMenu(), Object.keys(objRetornado2));    --> linha inserida por mim
    ...
    // assert.deepStrictEqual(objetoRetornado, objetoRetornado.fetchMenu()); --> linha inserida por mim
